...
TOKEN = '7937963960:AAFA0IzNwtvOpHo-F5eRu9G-oAeZjormTL0'
ADMIN_USER_ID = 898594603  # Replace with the actual admin user ID
...
def attack_command(message):
    ...
    try:
        ...
        if user_data['plan'] == 1 and users_collection.count_documents({"plan": 1}) > 99:
            bot.send_message(chat_id, "Your 🧡 plan is currently not available due to limit reached.")
            return
...
def send_welcome(message):
    ...
    # Create buttons
    btn2 = KeyboardButton("FLOOD START 💥")
